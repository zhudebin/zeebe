...
type UpdateClusterSizeInitRequest struct {
	NewClusterSize       int32    `protobuf:"varint,1,opt,name=newClusterSize,proto3" json:"newClusterSize,omitempty"`
...
func (m *UpdateClusterSizeInitRequest) Reset()         { *m = UpdateClusterSizeInitRequest{} }
func (m *UpdateClusterSizeInitRequest) String() string { return proto.CompactTextString(m) }
func (*UpdateClusterSizeInitRequest) ProtoMessage()    {}
func (*UpdateClusterSizeInitRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f1a937782ebbded5, []int{31}
}

func (m *UpdateClusterSizeInitRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_UpdateClusterSizeInitRequest.Unmarshal(m, b)
}
func (m *UpdateClusterSizeInitRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_UpdateClusterSizeInitRequest.Marshal(b, m, deterministic)
}
func (m *UpdateClusterSizeInitRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateClusterSizeInitRequest.Merge(m, src)
}
func (m *UpdateClusterSizeInitRequest) XXX_Size() int {
	return xxx_messageInfo_UpdateClusterSizeInitRequest.Size(m)
}
func (m *UpdateClusterSizeInitRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_UpdateClusterSizeInitRequest.DiscardUnknown(m)
}

var xxx_messageInfo_UpdateClusterSizeInitRequest proto.InternalMessageInfo

func (m *UpdateClusterSizeInitRequest) GetNewClusterSize() int32 {
	if m != nil {
...
func (m *UpdateClusterSizeInitRequest) GetNodeId() int32 {
	if m != nil {
		return m.NodeId
	}
	return 0
...
type UpdateClusterSizeInitResponse struct {
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *UpdateClusterSizeInitResponse) Reset()         { *m = UpdateClusterSizeInitResponse{} }
func (m *UpdateClusterSizeInitResponse) String() string { return proto.CompactTextString(m) }
func (*UpdateClusterSizeInitResponse) ProtoMessage()    {}
func (*UpdateClusterSizeInitResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f1a937782ebbded5, []int{32}
}

func (m *UpdateClusterSizeInitResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_UpdateClusterSizeInitResponse.Unmarshal(m, b)
}
func (m *UpdateClusterSizeInitResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_UpdateClusterSizeInitResponse.Marshal(b, m, deterministic)
}
func (m *UpdateClusterSizeInitResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateClusterSizeInitResponse.Merge(m, src)
}
func (m *UpdateClusterSizeInitResponse) XXX_Size() int {
	return xxx_messageInfo_UpdateClusterSizeInitResponse.Size(m)
}
func (m *UpdateClusterSizeInitResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_UpdateClusterSizeInitResponse.DiscardUnknown(m)
}

var xxx_messageInfo_UpdateClusterSizeInitResponse proto.InternalMessageInfo

type UpdateClusterSizeCommitRequest struct {
	NewClusterSize       int32    `protobuf:"varint,1,opt,name=newClusterSize,proto3" json:"newClusterSize,omitempty"`
	NodeId               int32    `protobuf:"varint,2,opt,name=nodeId,proto3" json:"nodeId,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
...
func (m *UpdateClusterSizeCommitRequest) Reset()         { *m = UpdateClusterSizeCommitRequest{} }
func (m *UpdateClusterSizeCommitRequest) String() string { return proto.CompactTextString(m) }
func (*UpdateClusterSizeCommitRequest) ProtoMessage()    {}
func (*UpdateClusterSizeCommitRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f1a937782ebbded5, []int{33}
}

func (m *UpdateClusterSizeCommitRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_UpdateClusterSizeCommitRequest.Unmarshal(m, b)
}
func (m *UpdateClusterSizeCommitRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_UpdateClusterSizeCommitRequest.Marshal(b, m, deterministic)
}
func (m *UpdateClusterSizeCommitRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateClusterSizeCommitRequest.Merge(m, src)
}
func (m *UpdateClusterSizeCommitRequest) XXX_Size() int {
	return xxx_messageInfo_UpdateClusterSizeCommitRequest.Size(m)
}
func (m *UpdateClusterSizeCommitRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_UpdateClusterSizeCommitRequest.DiscardUnknown(m)
}

var xxx_messageInfo_UpdateClusterSizeCommitRequest proto.InternalMessageInfo

func (m *UpdateClusterSizeCommitRequest) GetNewClusterSize() int32 {
	if m != nil {
		return m.NewClusterSize
	}
	return 0
...
func (m *UpdateClusterSizeCommitRequest) GetNodeId() int32 {
	if m != nil {
		return m.NodeId
	}
	return 0
...
type UpdateClusterSizeCommitResponse struct {
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *UpdateClusterSizeCommitResponse) Reset()         { *m = UpdateClusterSizeCommitResponse{} }
func (m *UpdateClusterSizeCommitResponse) String() string { return proto.CompactTextString(m) }
func (*UpdateClusterSizeCommitResponse) ProtoMessage()    {}
func (*UpdateClusterSizeCommitResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f1a937782ebbded5, []int{34}
}

func (m *UpdateClusterSizeCommitResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_UpdateClusterSizeCommitResponse.Unmarshal(m, b)
}
func (m *UpdateClusterSizeCommitResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_UpdateClusterSizeCommitResponse.Marshal(b, m, deterministic)
}
func (m *UpdateClusterSizeCommitResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateClusterSizeCommitResponse.Merge(m, src)
}
func (m *UpdateClusterSizeCommitResponse) XXX_Size() int {
	return xxx_messageInfo_UpdateClusterSizeCommitResponse.Size(m)
}
func (m *UpdateClusterSizeCommitResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_UpdateClusterSizeCommitResponse.DiscardUnknown(m)
}

var xxx_messageInfo_UpdateClusterSizeCommitResponse proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*UpdateClusterSizeInitRequest)(nil), "gateway_protocol.UpdateClusterSizeInitRequest")
	proto.RegisterType((*UpdateClusterSizeInitResponse)(nil), "gateway_protocol.UpdateClusterSizeInitResponse")
	proto.RegisterType((*UpdateClusterSizeCommitRequest)(nil), "gateway_protocol.UpdateClusterSizeCommitRequest")
	proto.RegisterType((*UpdateClusterSizeCommitResponse)(nil), "gateway_protocol.UpdateClusterSizeCommitResponse")
}
...
var fileDescriptor_f1a937782ebbded5 = []byte{
	...
	,
}
...
type GatewayClient interface {
	...
	UpdateClusterSizeInit(ctx context.Context, in *UpdateClusterSizeInitRequest, opts ...grpc.CallOption) (*UpdateClusterSizeInitResponse, error)
	UpdateClusterSizeCommit(ctx context.Context, in *UpdateClusterSizeCommitRequest, opts ...grpc.CallOption) (*UpdateClusterSizeCommitResponse, error)
}
...
func (c *gatewayClient) UpdateClusterSizeInit(ctx context.Context, in *UpdateClusterSizeInitRequest, opts ...grpc.CallOption) (*UpdateClusterSizeInitResponse, error) {
	out := new(UpdateClusterSizeInitResponse)
	err := c.cc.Invoke(ctx, "/gateway_protocol.Gateway/UpdateClusterSizeInit", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayClient) UpdateClusterSizeCommit(ctx context.Context, in *UpdateClusterSizeCommitRequest, opts ...grpc.CallOption) (*UpdateClusterSizeCommitResponse, error) {
	out := new(UpdateClusterSizeCommitResponse)
	err := c.cc.Invoke(ctx, "/gateway_protocol.Gateway/UpdateClusterSizeCommit", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GatewayServer interface {
	...
	UpdateClusterSizeInit(context.Context, *UpdateClusterSizeInitRequest) (*UpdateClusterSizeInitResponse, error)
	UpdateClusterSizeCommit(context.Context, *UpdateClusterSizeCommitRequest) (*UpdateClusterSizeCommitResponse, error)
}
...
func (*UnimplementedGatewayServer) UpdateClusterSizeInit(ctx context.Context, req *UpdateClusterSizeInitRequest) (*UpdateClusterSizeInitResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateClusterSizeInit not implemented")
}
func (*UnimplementedGatewayServer) UpdateClusterSizeCommit(ctx context.Context, req *UpdateClusterSizeCommitRequest) (*UpdateClusterSizeCommitResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateClusterSizeCommit not implemented")
}
...
func _Gateway_UpdateClusterSizeInit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateClusterSizeInitRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GatewayServer).UpdateClusterSizeInit(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gateway_protocol.Gateway/UpdateClusterSizeInit",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GatewayServer).UpdateClusterSizeInit(ctx, req.(*UpdateClusterSizeInitRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Gateway_UpdateClusterSizeCommit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateClusterSizeCommitRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GatewayServer).UpdateClusterSizeCommit(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gateway_protocol.Gateway/UpdateClusterSizeCommit",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GatewayServer).UpdateClusterSizeCommit(ctx, req.(*UpdateClusterSizeCommitRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Gateway_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateClusterSizeInit",
			Handler:    _Gateway_UpdateClusterSizeInit_Handler,
		},
		{
			MethodName: "UpdateClusterSizeCommit",
			Handler:    _Gateway_UpdateClusterSizeCommit_Handler,
		},
	},
