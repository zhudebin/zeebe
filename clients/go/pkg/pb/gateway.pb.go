...
type ProcessRequestObject_ResourceType int32

const (
	// FILE type means the gateway will try to detect the resource type
	// using the file extension of the name field
	ProcessRequestObject_FILE ProcessRequestObject_ResourceType = 0
	ProcessRequestObject_BPMN ProcessRequestObject_ResourceType = 1 // extension 'bpmn'
	// Deprecated: Do not use.
	ProcessRequestObject_YAML ProcessRequestObject_ResourceType = 2 // extension 'yaml'; deprecated as of release 1.0
)

// Enum value maps for ProcessRequestObject_ResourceType.
var (
	ProcessRequestObject_ResourceType_name = map[int32]string{
		0: "FILE",
		1: "BPMN",
		2: "YAML",
	}
	ProcessRequestObject_ResourceType_value = map[string]int32{
		"FILE": 0,
		"BPMN": 1,
		"YAML": 2,
	}
...
func (x ProcessRequestObject_ResourceType) Enum() *ProcessRequestObject_ResourceType {
	p := new(ProcessRequestObject_ResourceType)
	*p = x
	return p
}

func (x ProcessRequestObject_ResourceType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ProcessRequestObject_ResourceType) Descriptor() protoreflect.EnumDescriptor {
	return file_gateway_proto_enumTypes[0].Descriptor()
}

func (ProcessRequestObject_ResourceType) Type() protoreflect.EnumType {
	return &file_gateway_proto_enumTypes[0]
}

func (x ProcessRequestObject_ResourceType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ProcessRequestObject_ResourceType.Descriptor instead.
func (ProcessRequestObject_ResourceType) EnumDescriptor() ([]byte, []int) {
...
type ActivatedJob struct {
	...
	ProcessKey int64 `protobuf:"varint,6,opt,name=processKey,proto3" json:"processKey,omitempty"`
...
func (x *ActivatedJob) GetProcessKey() int64 {
	if x != nil {
		return x.ProcessKey
	}
	return 0
...
type CreateProcessInstanceRequest struct {
	...
	ProcessKey int64 `protobuf:"varint,1,opt,name=processKey,proto3" json:"processKey,omitempty"`
...
func (x *CreateProcessInstanceRequest) GetProcessKey() int64 {
	if x != nil {
		return x.ProcessKey
	}
	return 0
...
func (x *CreateProcessInstanceResponse) GetProcessKey() int64 {
	if x != nil {
		return x.ProcessKey
	}
	return 0
...
func (x *CreateProcessInstanceWithResultResponse) GetProcessKey() int64 {
	if x != nil {
		return x.ProcessKey
	}
	return 0
...
type DeployProcessRequest struct {
	...
	Processs []*ProcessRequestObject `protobuf:"bytes,1,rep,name=processs,proto3" json:"processs,omitempty"`
}
...
func (x *DeployProcessRequest) GetProcesss() []*ProcessRequestObject {
	if x != nil {
		return x.Processs
	}
	return nil
...
type ProcessRequestObject struct {
	...
	//
	// Deprecated: Do not use.
	Type ProcessRequestObject_ResourceType `protobuf:"varint,2,opt,name=type,proto3,enum=gateway_protocol.ProcessRequestObject_ResourceType" json:"type,omitempty"`
...
// Deprecated: Do not use.
func (x *ProcessRequestObject) GetType() ProcessRequestObject_ResourceType {
	if x != nil {
		return x.Type
	}
	return ProcessRequestObject_FILE
}
...
type DeployProcessResponse struct {
	...
	Key int64 `protobuf:"varint,1,opt,name=key,proto3" json:"key,omitempty"`
	// a list of deployed processs
	Processs []*ProcessMetadata `protobuf:"bytes,2,rep,name=processs,proto3" json:"processs,omitempty"`
}
...
func (x *DeployProcessResponse) GetProcesss() []*ProcessMetadata {
	if x != nil {
		return x.Processs
	}
	return nil
...
type ProcessMetadata struct {
	...
	ProcessKey int64 `protobuf:"varint,3,opt,name=processKey,proto3" json:"processKey,omitempty"`
...
func (x *ProcessMetadata) GetProcessKey() int64 {
	if x != nil {
		return x.ProcessKey
	}
	return 0
...
var file_gateway_proto_goTypes = []interface{}{
	...
	(*DeployProcessRequest)(nil),                    // 14: gateway_protocol.DeployProcessRequest
...
var file_gateway_proto_depIdxs = []int32{
	...
	10, // 1: gateway_protocol.CreateProcessInstanceWithResultRequest.request:type_name -> gateway_protocol.CreateProcessInstanceRequest
	15, // 2: gateway_protocol.DeployProcessRequest.processs:type_name -> gateway_protocol.ProcessRequestObject
	0,  // 3: gateway_protocol.ProcessRequestObject.type:type_name -> gateway_protocol.ProcessRequestObject.ResourceType
	17, // 4: gateway_protocol.DeployProcessResponse.processs:type_name -> gateway_protocol.ProcessMetadata
	...
	6,  // 10: gateway_protocol.Gateway.CancelProcessInstance:input_type -> gateway_protocol.CancelProcessInstanceRequest
	8,  // 11: gateway_protocol.Gateway.CompleteJob:input_type -> gateway_protocol.CompleteJobRequest
	10, // 12: gateway_protocol.Gateway.CreateProcessInstance:input_type -> gateway_protocol.CreateProcessInstanceRequest
	12, // 13: gateway_protocol.Gateway.CreateProcessInstanceWithResult:input_type -> gateway_protocol.CreateProcessInstanceWithResultRequest
	14, // 14: gateway_protocol.Gateway.DeployProcess:input_type -> gateway_protocol.DeployProcessRequest
	...
	7,  // 23: gateway_protocol.Gateway.CancelProcessInstance:output_type -> gateway_protocol.CancelProcessInstanceResponse
	9,  // 24: gateway_protocol.Gateway.CompleteJob:output_type -> gateway_protocol.CompleteJobResponse
	11, // 25: gateway_protocol.Gateway.CreateProcessInstance:output_type -> gateway_protocol.CreateProcessInstanceResponse
	13, // 26: gateway_protocol.Gateway.CreateProcessInstanceWithResult:output_type -> gateway_protocol.CreateProcessInstanceWithResultResponse
	16, // 27: gateway_protocol.Gateway.DeployProcess:output_type -> gateway_protocol.DeployProcessResponse
...
type GatewayClient interface {
	...
	//latest deployed version. Note that only processs with none start events can be started through
	//this command.
	//
	//Errors:
	//NOT_FOUND:
	...
	//
	//FAILED_PRECONDITION:
	//- the process definition does not contain a none start event; only processs with none
	...
	//
	//Deploys one or more processs to Zeebe. Note that this is an atomic call,
	//i.e. either all processs are deployed, or none of them are.
	//
	//Errors:
	//INVALID_ARGUMENT:
	//- no resources given.
