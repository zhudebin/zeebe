...
func TestCreateProcessInstanceCommand(t *testing.T) {
	...
	response, err := command.ProcessKey(123).Send(context.Background())
...
func TestCreateProcessInstanceCommandWithVariablesFromString(t *testing.T) {
	...
	variablesCommand, err := command.ProcessKey(123).VariablesFromString(variables)
	if err != nil {
...
func TestCreateProcessInstanceCommandWithVariablesFromStringer(t *testing.T) {
	...
	variablesCommand, err := command.ProcessKey(123).VariablesFromStringer(DataType{Foo: "bar"})
	if err != nil {
		t.Error("Failed to set variables: ", err)
	}
...
func TestCreateProcessInstanceCommandWithVariablesFromObject(t *testing.T) {
	...
	variablesCommand, err := command.ProcessKey(123).VariablesFromObject(DataType{Foo: "bar"})
	if err != nil {
		t.Error("Failed to set variables: ", err)
	}
...
func TestCreateProcessInstanceCommandWithVariablesFromObjectOmitempty(t *testing.T) {
	...
	variablesCommand, err := command.ProcessKey(123).VariablesFromObject(DataType{Foo: ""})
	if err != nil {
		t.Error("Failed to set variables: ", err)
	}
...
func TestCreateProcessInstanceCommandWithVariablesFromObjectIgnoreOmitempty(t *testing.T) {
	...
	variablesCommand, err := command.ProcessKey(123).VariablesFromObjectIgnoreOmitempty(DataType{Foo: ""})
	if err != nil {
		t.Error("Failed to set variables: ", err)
	}
...
func TestCreateProcessInstanceCommandWithVariablesFromMap(t *testing.T) {
	...
	variablesCommand, err := command.ProcessKey(123).VariablesFromMap(variablesMap)
	if err != nil {
		t.Error("Failed to set variables: ", err)
	}
...
func TestCreateProcessInstanceWithResultCommand(t *testing.T) {
	...
	response, err := command.ProcessKey(123).WithResult().Send(ctx)
...
func TestCreateProcessInstanceWithResultAndFetchVariablesCommand(t *testing.T) {
	...
	response, err := command.ProcessKey(123).WithResult().FetchVariables("a", "b", "c").Send(ctx)
...
func TestCreateProcessInstanceWithResultAndFetchEmptyVariablesListCommand(t *testing.T) {
	...
	response, err := command.ProcessKey(123).WithResult().FetchVariables().Send(ctx)
