...
public final class MessageStartEventSubscriptionTest {
  ...
  public void shouldCloseSubscriptionForOldVersions() {
    ...
    final long closingProcessKey = subscriptions.get(2).getValue().getProcessKey();
    assertThat(closingProcessKey).isEqualTo(subscriptions.get(0).getValue().getProcessKey());
  }
