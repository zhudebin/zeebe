...
public final class JobWorkerTest {
  ...
  public void shouldActivateJob() {
            ...
            .serviceTask(
                ...
                t ->
                    t.zeebeJobType(jobType)
                        ...
                        .zeebeTaskHeader("y", "2"))
            .done();
    final var processKey = CLIENT_RULE.deployProcess(process);

    final var processInstanceKey =
        CLIENT_RULE.createProcessInstance(processKey, "{\"a\":1, \"b\":2}");
    ...
    assertThat(job.getProcessKey()).isEqualTo(processKey);
