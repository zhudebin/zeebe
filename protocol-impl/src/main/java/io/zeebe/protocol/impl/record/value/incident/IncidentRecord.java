...
public final class IncidentRecord extends UnifiedRecordValue implements IncidentRecordValue {
  ...
  private final LongProperty processKeyProp = new LongProperty("processKey", -1L);
  ...
  public void wrap(final IncidentRecord record) {
    ...
    processKeyProp.setValue(record.getProcessKey());
  ...
  public IncidentRecord initFromProcessInstanceFailure(
    ...
    setProcessKey(processInstanceEvent.getProcessKey());
  ...
  public IncidentRecord setProcessKey(final long processKey) {
