...
public final class ProcessInstanceCreationRecord extends UnifiedRecordValue
  ...
  private final LongProperty processKeyProperty = new LongProperty("processKey", -1);
  ...
  public ProcessInstanceCreationRecord() {
    declareProperty(bpmnProcessIdProperty)
        .declareProperty(processKeyProperty)
  ...
  public long getProcessKey() {
    return processKeyProperty.getValue();
  }

  public ProcessInstanceCreationRecord setProcessKey(final long key) {
    processKeyProperty.setValue(key);
    return this;
  }
